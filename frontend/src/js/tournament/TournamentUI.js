...
export class TournamentUI {
    ...
    setupEventListeners() {
        ...
        (_a = document.getElementById('localTournament')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (selectPlayers) {
                ...
                const newSelectPlayers = document.getElementById("select-players");
                newSelectPlayers === null || newSelectPlayers === void 0 ? void 0 : newSelectPlayers.addEventListener("click", (e) => {
                    e.preventDefault();
    ...
    resetConfigSliders() {
        ...
        if (difficultySlider) {
            ...
            if (difficultyValue)
                difficultyValue.textContent = difficultyLabels[1];
        }
    }
    /**
