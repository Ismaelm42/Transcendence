...
export function waitForSocketOpen(): Promise<void> {
...
export function sendPieceMove(fromSquare: string, toSquare: string) {
...
export function promoteToPiece(fromSquare:string, toSquare: string, piece: string) {
