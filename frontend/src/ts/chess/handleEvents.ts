...
function dropPiece(event: MouseEvent, piece: string, chessboard: Chessboard, canvas: HTMLCanvasElement) {
...
function activateMouseListeners(piece: string, chessboard: Chessboard, canvas: HTMLCanvasElement) {
